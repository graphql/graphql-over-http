...
# GraphQL-over-HTTP WG — July 2026
...
- **Date & Time**: [August 5, 2026, 11:00 AM – 12:00 PM PDT](https://www.timeanddate.com/worldclock/converter.html?iso=20260805T180000&&p1=3775&p2=110&p3=24&p4=37&p5=188&p6=496&p7=676&p8=438&p9=268&p10=234&p11=78&p12=604)
...
1. Make 405 "RECOMMENDED" (5min, Martin)
   - https://github.com/graphql/graphql-over-http/pull/410
   - Aim: feedback
1. `QUERY` HTTP verb (5min, Martin)
   - https://github.com/graphql/graphql-over-http/pull/411
   - Aim: feedback
1. Release status (5min, Martin)
   - When do we plan the release, what scope?
   - Aim: synchronization
